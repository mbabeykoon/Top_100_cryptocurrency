...
""")
path=r"D:\Intern\CryptoP\images.jfif"
image = Image.open(open(path, 'rb'))

st.image(image, width=500)
st.markdown(""" * **Photo Credit:**(https://www.schwab.com/resource-center/insights/content/cryptocurrencies-should-you-invest-them)""")
#---------------------------------#
# About
